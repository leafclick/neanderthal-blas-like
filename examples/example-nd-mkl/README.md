...
## Try out batched GEMM
    ...
    $ lein repl
    nREPL server started on port 44693 on host 127.0.0.1 - nrepl://127.0.0.1:44693
    ...
    Warning: Versions of org.bytedeco:javacpp:1.5.12 and org.bytedeco:dnnl:3.9.2-1.5.13-SNAPSHOT do not match.
    Warning: Versions of org.bytedeco:javacpp:1.5.12 and org.bytedeco:opencl:3.0-1.5.13-SNAPSHOT do not match.
